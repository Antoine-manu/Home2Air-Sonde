...
# Create a stream with the name "mystream"
    ...
    results = []
    results.append('Temp :' + round(temperatureClass.adjusted_temperature(bme280, comp_temp_cub_a, comp_temp_cub_b, comp_temp_cub_c ,comp_temp_cub_d), 2))
    results.append('Preasure :' + round(bme280.get_pressure(), 2))
    results.append('Humdity :' + round(humidityClass.adjusted_humidity(bme280, comp_hum_quad_a, comp_hum_quad_b, comp_hum_quad_c), 2))
    results.append('Lux :' + round(ltr559.get_lux(), 2))
    results.append('Gas PPM :' + round(gas_in_ppm[0], 2))
    results.append('Gas PPM :' + round(gas_in_ppm[1], 2))
    results.append('Gas PPM :' + round(gas_in_ppm[2], 2))
    results.append('Particule 1 :' + round(particuleClass.get_particules_values(1.0)))
    results.append('Particule 2.5 :' + round(particuleClass.get_particules_values(2.5)))
    results.append('Particule 10 :' + round(particuleClass.get_particules_values(10)))
